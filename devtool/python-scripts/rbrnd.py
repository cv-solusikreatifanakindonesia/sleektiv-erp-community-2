...
_help = '''#######################################################################################################
Run command  : python rbrnd.py <path> [--copy/-c] [--help/-h]

@param -> rbrnd.py : to convert odoo modules to sleektiv community
...
@example> For Help       : python rbrnd.py [-h]
@example> Without Copy   : python rbrnd.py /home/<system_user>/<module_name>
@example> With Copy      : python rbrnd.py /home/<system_user>/<module_name> --copy

**Note ::
- If you execute this script on migrated module then there is possibility that you can get following kind of strings:
    -- "sleektiv, sleektiv",
    -- "odoo, sleektiv, sleektiv" 
...
replacements = {
    ...
    'ODOO': 'SLEEKTIV',
    '8069': '7073',
    'Part of Sleektiv.': 'Part of Odoo, Sleektiv.',
    'openerp': 'sleektiv',
    'Openerp': 'Sleektiv',
    'OpenERP': 'Sleektiv',
    'OpenErp': 'Sleektiv',
    'OPENERP': 'SLEEKTIV',
    'Part of Openerp.': 'Part of Openerp, Sleektiv.',
}
...
xml_replacements = {
    ...
    'Odoo': 'Sleektiv',
    'ODOO': 'SLEEKTIV',
    'Part of Odoo.': 'Part of Odoo, Sleektiv.',
    'openerp': 'sleektiv',
    'Openerp': 'Sleektiv',
    'OpenERP': 'Sleektiv',
    'OpenErp': 'Sleektiv',
...
website_replacements = {
    'https://www.odoo.com': 'https://sleektiv.com',
    'www.odoo.com': 'https://sleektiv.com',
    'https://www.openerp.com': 'https://sleektiv.com',
    'www.opernerp.com': 'https://sleektiv.com',
}

replace_email = {
    'info@odoo.com': 'info@solusikreatifanakindonesia.com',
    'info@openerp.com': 'info@solusikreatifanakindonesia.com',
}
