...
from sleektiv.addons.base.tests.test_expression import TransactionExpressionCase
...
class One2manyCase(TransactionExpressionCase):
    ...
    @mute_logger('sleektiv.osv.expression')
    def test_create_one2many_with_unsearchable_field(self):
        # sleektiv.osv.expression is muted as reading a non-stored and unsearchable field will log an error and makes the runbot red
