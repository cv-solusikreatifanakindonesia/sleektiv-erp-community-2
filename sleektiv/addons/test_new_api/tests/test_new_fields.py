...
from sleektiv import models, fields, Command
...
from sleektiv.tests import TransactionCase, tagged, Form, users
...
%endif"""
    ...
    @patch('sleektiv.fields.html_sanitize', return_value='<p>comment</p>')
