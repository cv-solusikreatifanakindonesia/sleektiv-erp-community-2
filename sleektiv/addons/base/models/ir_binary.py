...
from sleektiv.exceptions import MissingError, UserError
from sleektiv.http import Stream, request
from sleektiv.tools import file_open, replace_exceptions
from sleektiv.tools.image import image_process, image_guess_size_from_field_name
from sleektiv.tools.mimetypes import guess_mimetype, get_extension
from sleektiv.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:sleektiv.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~sleektiv.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`sleektiv.tools.image.image_process`.
