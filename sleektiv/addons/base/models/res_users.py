...
from sleektiv import api, fields, models, tools, SUPERUSER_ID, _, Command
...
from sleektiv.http import request, DEFAULT_LANG
from sleektiv.osv import expression
from sleektiv.tools import is_html_empty, partition, frozendict, lazy_property, SQL, SetDefinitions
        ...
        if self._on_login_cooldown(failures, previous):
            ...
            if ipaddress.ip_address(source).is_private:
                _logger.warning(
                    ...
                    "https://www.sleektiv.com/documentation/master/administration/install/deploy.html#https for details.",
                    source
                )
...
class GroupsImplied(models.Model):
    ...
    def _get_group_definitions(self):
        """ Return the definition of all the groups as a :class:`~sleektiv.tools.SetDefinitions`. """
