...
from sleektiv import release, SUPERUSER_ID, _
from sleektiv.http import request
from sleektiv.tools import (func, misc, transpile_javascript,
    is_sleektiv_module, SourceMapGenerator, profiler, OrderedSet)
from sleektiv.tools.json import scriptsafe as json
from sleektiv.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS
from sleektiv.tools.misc import file_open, file_path
            ...
            if self.templates:
                ...
                template_bundle = textwrap.dedent(f"""
                    ...
                    *******************************************/
                    ...
                    sleektiv.define("{self.name}.bundle.xml", ["@web/core/templates"], function(require) {{
                        "use strict";
        ...
        * 't-inherit-mode':  'primary' or 'extension'.
        ...
        for asset in self.templates:
            ...
            try:
                ...
                template = content if content.startswith('<sleektiv>') else f'<templates>{asset.content}</templates>'
...
class JavascriptAsset(WebAsset):
    ...
    def is_transpiled(self):
        if self._is_transpiled is None:
            self._is_transpiled = bool(is_sleektiv_module(self.url, super().content))
