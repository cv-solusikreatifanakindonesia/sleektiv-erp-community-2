...
<https://www.sleektiv.com/documentation/master/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed sleektiv user group, or preceded by ``!`` for
prohibited groups
...
from sleektiv.modules import registry
from sleektiv.tools import config, safe_eval, pycompat
from sleektiv.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from sleektiv.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from sleektiv.tools.json import scriptsafe
from sleektiv.tools.lru import LRU
from sleektiv.tools.misc import str2bool
from sleektiv.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from sleektiv.http import request
from sleektiv.tools.profiler import QwebTracker
from sleektiv.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from sleektiv.addons.base.models.assetsbundle import AssetsBundle
from sleektiv.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__sleektivAssetError=1"
