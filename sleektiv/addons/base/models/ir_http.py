...
from sleektiv.http import request, Response, ROUTING_KEYS
from sleektiv.modules.registry import Registry
from sleektiv.service import security
from sleektiv.tools.json import json_default
from sleektiv.tools.misc import get_lang, submap
from sleektiv.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and sleektiv.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (sleektiv.exceptions.AccessError, sleektiv.exceptions.MissingError) as e:
                ...
                if isinstance(e, sleektiv.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(sleektiv.conf.server_wide_modules)
