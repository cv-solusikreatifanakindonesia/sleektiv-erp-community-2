...
import sleektiv
from sleektiv.http import Controller, route, dispatch_rpc, request, Response
from sleektiv.fields import Date, Datetime, Command
...
def xmlrpc_handle_exception_string(e):
    ...
    #InternalError
        ...
        info = sys.exc_info()
        formatted_info = "".join(traceback.format_exception(*info))
        fault = xmlrpc.client.Fault(sleektiv.tools.exception_to_unicode(e), formatted_info)
