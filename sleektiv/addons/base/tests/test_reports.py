...
@sleektiv.tests.tagged('post_install', '-at_install', 'post_install_l10n')
...
class TestReportsRenderingCommon(sleektiv.tests.HttpCase):
    ...
    def save_pdf(self):
        ...
        sleektiv.tests.save_test_file(self._testMethodName, self.last_pdf_content, 'pdf_', 'pdf', document_type='Report PDF', logger=_logger)
...
@sleektiv.tests.tagged('post_install', '-at_install', 'pdf_rendering')
...
@sleektiv.tests.tagged('post_install', '-at_install', '-standard', 'pdf_rendering')
...
class TestAggregatePdfReports(sleektiv.tests.HttpCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
