...
from sleektiv.addons.base.models.res_users import is_selection_groups, get_selection_groups, name_selection_groups
from sleektiv.exceptions import UserError, ValidationError
from sleektiv.http import _request_stack
from sleektiv.tests import Form, TransactionCase, new_test_user, tagged, HttpCase, users
...
class TestUsers(TransactionCase):
    ...
    @mute_logger('sleektiv.sql_db', 'sleektiv.addons.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('sleektiv.addons.base.models.res_users.request', request)
