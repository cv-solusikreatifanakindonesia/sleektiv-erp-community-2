...
from sleektiv import modules
from sleektiv.exceptions import UserError
from sleektiv.tools import config, file_path, mute_logger
...
@patch('sleektiv.addons.base.models.ir_mail_server.SMTP_TIMEOUT', .1)
...
class TestIrMailServerSMTPD(TransactionCaseWithUserDemo):
    ...
    def setUpClass(cls):
        ...
        # decrease aiosmtpd verbosity, sleektiv INFO = aiosmtpd WARNING
        ...
        # force aiosmtpd/sleektiv to bind/connect to a fixed ipv4 OR ipv6
        # address.
