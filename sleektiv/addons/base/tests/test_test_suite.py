...
from sleektiv.tests.case import TestCase
from sleektiv.tests.common import BaseCase, TransactionCase, users, warmup
from sleektiv.tests.result import OdooTestResult

_logger = logging.getLogger(__name__)

from sleektiv.tests import MetaCase
...
class TestRunnerLoggingCommon(TransactionCase):
    ...
    def _clean_message(self, message):
        root_path = PurePath(__file__).parents[4]  # removes /sleektiv/addons/base/tests/test_test_suite.py
