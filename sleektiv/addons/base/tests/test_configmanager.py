...
from sleektiv.tools import file_path, file_open, file_open_temporary_directory
from sleektiv.tools.config import conf, configmanager, _get_default_datadir


IS_POSIX = 'workers' in sleektiv.tools.config.options
ROOT_PATH = sleektiv.tools.config.options['root_path'].removesuffix('/sleektiv')
...
class TestConfigManager(TransactionCase):
    ...
    def setUp(self):
        ...
        self.patch(conf, 'addons_paths', sleektiv.conf.addons_paths)
        self.patch(conf, 'server_wide_modules', sleektiv.conf.server_wide_modules)
    ...
    def test_01_default_config(self):
        ...
        default_values = {
            ...
            'admin_passwd': 'admin',
            'csv_internal_sep': ',',
            'publisher_warranty_url': 'http://services.sleektiv.com/publisher-warranty/',
            'reportgz': False,
            'root_path': f'{ROOT_PATH}/sleektiv',
            ...
            'import_partial': '',
            'pidfile': '',
            'addons_path': f'{ROOT_PATH}/sleektiv/addons,{ROOT_PATH}/addons',
            'upgrade_path': '',
            ...
            'test_tags': None,
            'screencasts': '',
            'screenshots': '/tmp/sleektiv_tests',
    ...
    def test_02_config_file(self):
        values = {
            ...
            'reportgz': True,
            'root_path': f'{ROOT_PATH}/sleektiv',  # blacklist for save, ignored from the config file
    ...
    def test_04_sleektiv16_config_file(self):
    ...
    def test_06_cli(self):
        ...
        values = {
            ...
            'log_handler': [
                ':INFO',
                'sleektiv.tools.config:DEBUG',
                ':WARNING',
                'sleektiv.http:DEBUG',
                'sleektiv.sql_db:DEBUG',
            ],
            'log_db': 'logdb',
            'log_db_level': 'debug',
            'log_level': 'debug',
