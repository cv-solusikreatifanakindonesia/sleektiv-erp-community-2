...
from sleektiv.tests.common import BaseCase, TransactionCase
from sleektiv.tools import SQL, mute_logger, sql
...
class TestSqlTools(TransactionCase):
    ...
    def test_add_constraint(self):
        ...
        with self.assertRaises(CheckViolation), mute_logger('sleektiv.sql_db'):
