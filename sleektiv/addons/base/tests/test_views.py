...
from sleektiv.tools import mute_logger, view_validation, safe_eval
from sleektiv.tools.cache import get_cache_key_counter
from sleektiv.addons.base.models import ir_ui_view
...
class ViewCase(TransactionCaseWithUserDemo):
    ...
    def assertInvalid(self, arch, expected_message=None, name='invalid view', inherit_id=False, model='ir.ui.view'):
        with mute_logger('sleektiv.addons.base.models.ir_ui_view'):
