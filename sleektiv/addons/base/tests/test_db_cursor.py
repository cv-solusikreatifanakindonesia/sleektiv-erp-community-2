...
from sleektiv.tests.common import BaseCase, HttpCase
from sleektiv.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = sleektiv.api.Environment(self.cr, sleektiv.SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('sleektiv.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:sleektiv.sql_db:Found different un-closed cursor', msg)
