...
from sleektiv.tools.translate import quote, unquote, xml_translate, html_translate, TranslationImporter, TranslationModuleReader
from sleektiv.tests.common import TransactionCase, BaseCase, new_test_user, tagged

_stats_logger = logging.getLogger('sleektiv.tests.stats')
    ...
    def test_translate_xml_a(self):
        ...
        source = """<t t-name="stuff">
                        <ul class="nav navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link oe_menu_leaf" href="/sleektiv/action-54?menu_id=42">
...
class TestLanguageInstall(TransactionCase):
    def test_language_install(self):
        ...
        with patch('sleektiv.addons.base.models.ir_module.Module._load_module_terms', _load_module_terms):
            wizard.lang_install()
...
class TestTranslationExport(TransactionCase):
    ...
    def test_export_translatable_resources(self):
        ...
        with self.assertNoLogs('sleektiv.tools.translate', "ERROR"):
