...
def parse_version(s):
    # can't use sleektiv.tools.parse_version because pythonpath is screwed from
...
class OdooBaseChecker(BaseChecker):
    ...
    msgs = {
        'E8502': (
            ...
            'gettext-variable',
            'See https://www.sleektiv.com/documentation/master/developer/misc/i18n/translations.html#variables'
        ),
        'E8505': (
