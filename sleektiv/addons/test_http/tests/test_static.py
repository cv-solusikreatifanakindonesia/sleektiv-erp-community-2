...
import sleektiv
from sleektiv.tests import new_test_user, tagged, RecordCapturer
from sleektiv.tools import config, file_open, image_process
from sleektiv.tools.misc import submap
...
class TestHttpStaticLogo(TestHttpStaticCommon):
    ...
    def setUpClass(cls):
        ...
        super_user = cls.env['res.users'].browse([sleektiv.SUPERUSER_ID])
