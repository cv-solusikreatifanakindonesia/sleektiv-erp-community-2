...
from sleektiv.tests.common import new_test_user, Like
from sleektiv.tools import mute_logger
from sleektiv.addons.test_http.utils import HtmlTokenizer
...
class TestHttpModels(TestHttpBase):
    ...
    def test_models5_stargate_setname_readonly(self):
        ...
        with self.assertLogs('sleektiv.http', 'WARNING') as capture_http,\
             self.assertLogs('sleektiv.sql_db', 'WARNING') as capture_sql_db:
