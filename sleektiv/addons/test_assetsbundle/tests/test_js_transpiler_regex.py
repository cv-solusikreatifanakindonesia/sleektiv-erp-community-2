...
from sleektiv.tools import URL_RE, ODOO_MODULE_RE
...
class TestJsTranspiler(TransactionCase):
    ...
    def test_correct_ODOO_MODULE_RE(self):
        cases = [
            ...
            '/*@sleektiv-module',
            '/**@sleektiv-module',
            '// @sleektiv-module alias=web.test',
            '/* @sleektiv-module  alias=web.test',
            '/** @sleektiv-module  alias=web.test',
            '/** @sleektiv-module  alias=web.test**/',
            '/* @sleektiv-module  alias=web.test ',
            '/* @sleektiv-module alias=web.test default=false',
            '/* @sleektiv-module alias=web.test default=false ',
            '/* @sleektiv-module alias=web.test default=false**/',
        ]
    ...
    def test_incorrect_ODOO_MODULE_RE(self):
        ...
        cases = [
            '// @sleektiv-modulealias=web.test',
            '/* @sleektiv-module alias=web.testdefault=false',
        ]
