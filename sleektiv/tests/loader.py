...
def get_test_modules(module):
    ...
    results = _get_tests_modules(importlib.util.find_spec(f'sleektiv.addons.{module}'))
...
def _get_upgrade_test_modules(module):
    upgrade_modules = (
        f"sleektiv.upgrade.{module}",
        f"sleektiv.addons.{module}.migrations",
        f"sleektiv.addons.{module}.upgrades",
    )
