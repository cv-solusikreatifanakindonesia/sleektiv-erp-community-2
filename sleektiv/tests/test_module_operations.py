...
if __name__ == '__main__':
    ...
    logging.config.dictConfig({
        ...
        'loggers': {
            'sleektiv.modules.loading': {'level': 'CRITICAL'},
            'sleektiv.sql_db': {'level': 'CRITICAL'},
            'sleektiv.models.unlink': {'level': 'WARNING'},
            'sleektiv.addons.base.models.ir_model': {'level': "WARNING"},
        }
    })
