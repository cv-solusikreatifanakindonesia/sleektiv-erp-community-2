...
It will initialize the `sleektiv.evented` variable.
"""
import sleektiv
import sys

sleektiv.evented = False


def patch_evented():
    if sleektiv.evented or not (len(sys.argv) > 1 and sys.argv[1] == 'gevent'):
        return
