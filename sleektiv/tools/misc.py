...
from sleektiv.loglevels import exception_to_unicode, get_encodings, ustr  # noqa: F401
...
def file_path(file_path: str, filter_ext: tuple[str, ...] = ('',), env: Environment | None = None) -> str:
    ...
    addons_paths = [*sleektiv.addons.__path__, root_path, *temporary_paths]
...
def file_open(name: str, mode: str = "r", filter_ext: tuple[str, ...] = (), env: Environment | None = None):
    ...
    Examples::
        ...
        >>> with file_open('/opt/sleektiv/addons/hr/static/description/icon.png', 'rb') as f:
        ...     contents = f.read()
...
def limited_field_access_token(record, field_name, timestamp=None):
    ...
    :type record: class:`sleektiv.models.Model`
