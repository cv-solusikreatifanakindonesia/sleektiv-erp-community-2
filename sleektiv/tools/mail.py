...
class _Cleaner(clean.Cleaner):
    ...
    def kill_conditional_comments(self, doc):
        ...
        https://github.com/sleektiv/sleektiv/pull/119325/files#r1301064789
...
def tag_quote(el):
    ...
    # sleektiv, gmail and outlook automatic signature wrapper
    is_signature_wrapper = 'sleektiv_signature_wrapper' in el_class or 'gmail_signature' in el_class or el_id == "Signature"
...
def plaintext2html(text, container_tag=None):
    ...
    html entities, using :func:`~sleektiv.tools.misc.html_escape`.
...
def _normalize_email(email):
    ...
    introduction of smtp-utf8 within sleektiv, this assumption is certain to fall
