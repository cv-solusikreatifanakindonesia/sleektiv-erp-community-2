...
from sleektiv.models import check_property_field_value_name, READ_GROUP_NUMBER_GRANULARITY
from sleektiv.tools import Query, SQL, get_lang
from sleektiv.tools.sql import pattern_to_translated_trigram_pattern, value_to_translated_trigram_pattern
...
def get_unaccent_wrapper(cr):
    ...
    return sleektiv.modules.registry.Registry(cr.dbname).unaccent
