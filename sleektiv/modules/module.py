...
class UpgradeHook(object):
    ...
    def find_spec(self, fullname, path=None, target=None):
        if re.match(r"^sleektiv\.addons\.base\.maintenance\.migrations\b", fullname):
...
def get_resource_from_path(path):
    ...
    """
    resource = False
    sorted_paths = sorted(sleektiv.addons.__path__, key=len, reverse=True)
...
def load_openerp_module(module_name):
    ...
    qualname = f'sleektiv.addons.{module_name}'
