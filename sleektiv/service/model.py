...
from sleektiv.tools import DotDict, lazy
from sleektiv.tools.translate import translate_sql_constraint
...
def execute_cr(cr, uid, obj, method, *args, **kw):
    ...
    result = retrying(partial(sleektiv.api.call_kw, recs, method, args, kw), env)
...
def retrying(func, env):
    ...
    :param sleektiv.api.Environment env: The environment where the registry
