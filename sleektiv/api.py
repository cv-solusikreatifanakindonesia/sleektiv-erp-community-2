...
def ondelete(*, at_uninstall):
    """
    Mark a method to be executed during :meth:`~sleektiv.models.BaseModel.unlink`.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        ...
        :type cursor: :class:`~sleektiv.sql_db.Cursor`
    ...
    def user(self):
        ...
        :rtype: :class:`res.users record<~sleektiv.addons.base.models.res_users.Users>`"""
    ...
    def company(self):
        ...
        :rtype: :class:`res.company record<~sleektiv.addons.base.models.res_company.Company>`
    ...
    def companies(self):
        ...
        :rtype: :class:`res.company recordset<~sleektiv.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry):
        ...
        # temporary directories (managed in sleektiv.tools.file_open_temporary_directory)
