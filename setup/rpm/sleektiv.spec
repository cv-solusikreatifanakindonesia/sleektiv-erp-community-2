%global name sleektiv
%global release 1
%global unmangled_version %{version}
%global __requires_exclude ^.*sleektiv/addons/mail/static/scripts/sleektiv-mailgate.py$

Summary: Sleektiv Community Server
Name: %{name}
Version: %{version}
Release: %{release}
...
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Sleektiv Community. <info@solusikreatifanakindonesia.com>
Requires: sassc
...
ODOO_CONFIGURATION_DIR=/etc/sleektiv
ODOO_CONFIGURATION_FILE=$ODOO_CONFIGURATION_DIR/sleektiv.conf
ODOO_DATA_DIR=/var/lib/sleektiv
ODOO_GROUP="sleektiv"
ODOO_LOG_DIR=/var/log/sleektiv
ODOO_LOG_FILE=$ODOO_LOG_DIR/sleektiv-server.log
ODOO_USER="sleektiv"
...
db_user = $ODOO_USER
db_password = False
addons_path = %{python3_sitelib}/sleektiv/addons
...
User=sleektiv
Group=sleektiv
ExecStart=/usr/bin/sleektiv --config $ODOO_CONFIGURATION_FILE --logfile $ODOO_LOG_FILE
KillMode=mixed
