...
/**
 * @typedef { Object } CollaborationSleektivShared
 * @property { CollaborationSleektivPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationSleektivPlugin extends Plugin {
    static id = "collaborationSleektiv";
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    ...
                    case "ptp_disconnect":
                        ...
                        // todo: to implement
                        // this.sleektivEditor.multiselectionRemove(fromPeerId);
                        break;
