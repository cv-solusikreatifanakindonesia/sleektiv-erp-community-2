...
from sleektiv.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
from sleektiv.tests.common import HttpCase, JsonRpcException
...
class TestSmsController(HttpCase, TestSMSActionsCommon):
    ...
    @mute_logger('sleektiv.addons.base.models.ir_http', 'sleektiv.addons.sms.controllers.main', 'sleektiv.http')
