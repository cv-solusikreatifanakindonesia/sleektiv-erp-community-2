...
class AccountJournal(models.Model):
    ...
    inbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Get paid by any method outside of Sleektiv.\n"
    ...
    outbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Pay by any method outside of Sleektiv.\n"
        "Check: Pay bills by check and print it from Sleektiv.\n"
    ...
    alias_id = fields.Many2one(help="Send one separate email for each invoice.\n\n"
                                    ...
                                    "Only PDF and XML files will be interpreted by Sleektiv")
