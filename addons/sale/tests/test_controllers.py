...
from sleektiv.addons.base.tests.common import BaseUsersCommon, HttpCaseWithUserPortal
...
class TestAccessRightsControllers(BaseUsersCommon, HttpCase, SaleCommon):
    ...
    @mute_logger('sleektiv.addons.base.models.ir_model', 'sleektiv.addons.base.models.ir_rule')
