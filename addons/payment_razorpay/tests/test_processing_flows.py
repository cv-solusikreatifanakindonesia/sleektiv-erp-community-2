...
from sleektiv.addons.payment_razorpay.controllers.main import RazorpayController
...
class TestProcessingFlows(RazorpayCommon, PaymentHttpCommon):
    ...
    @mute_logger('sleektiv.addons.payment_razorpay.controllers.main')
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'sleektiv.addons.payment_razorpay.controllers.main.RazorpayController.'
    ...
    def test_accept_webhook_notification_with_valid_signature(self):
        ...
        with patch(
            'sleektiv.addons.payment_razorpay.models.payment_provider.PaymentProvider'
