...
from sleektiv.addons.website_sale_autocomplete.controllers.main import AutoCompleteController
from sleektiv.tests import patch, HttpCase, tagged

CONTROLLER_PATH = 'sleektiv.addons.website_sale_autocomplete.controllers.main.AutoCompleteController'
