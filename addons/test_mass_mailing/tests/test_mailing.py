...
from sleektiv.tools import mute_logger, email_normalize
    ...
    def test_mailing_gateway_update(self):
        ...
        self.assertMailTraces(
            ...
            mail_links_info=[[
                ...
                ('url7', 'mailto:test@sleektiv.com', False, {}),
        ...
        # simulate a click
        self.gateway_mail_trace_click(mailing, recipients[0], 'https://www.sleektiv.be')
