...
import sleektiv
from sleektiv import models, tools
...
class TransifexTranslation(models.AbstractModel):
    ...
    def _get_transifex_projects(self):
        ...
        first section is [main], after '[sleektiv-16.sale]'
    ...
    def _update_transifex_url(self, translations):
        ...
        for translation in translations:
            ...
            # e.g. https://www.transifex.com/sleektiv/sleektiv-16/translate/#fr_FR/sale/42?q=text:'Sale+Order'
