...
from sleektiv.addons.mail.models.discuss.discuss_channel import channel_avatar, group_avatar
...
from sleektiv.tests import HttpCase, tagged, users
from sleektiv.tools import html_escape, mute_logger
