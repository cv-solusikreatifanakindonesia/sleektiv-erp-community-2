...
export class Thread extends Record {
    ...
    isCorrespondentSleektivBot = Record.attr(undefined, {
        compute() {
            return this.correspondent?.persona.eq(this.store.sleektivbot);
        },
    });
    ...
    get allowCalls() {
        return (
            ...
            !this.correspondent?.persona.eq(this.store.sleektivbot)
        );
    }
