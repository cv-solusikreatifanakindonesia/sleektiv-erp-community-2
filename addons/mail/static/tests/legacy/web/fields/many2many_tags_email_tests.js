/** @sleektiv-module alias=@mail/../tests/web/fields/many2many_tags_email_tests default=false */
...
test("fieldmany2many tags email popup close without filling", async (assert) => {
    const pyEnv = await startServer();
