...
class TestMailingControllers(TestMailingControllersCommon):
    ...
    @mute_logger('sleektiv.http', 'sleektiv.addons.website.models.ir_ui_view')
...
class TestMailingTracking(TestMailingControllersCommon):
    ...
    @mute_logger('sleektiv.addons.mail.models.mail_mail', 'sleektiv.addons.mass_mailing.models.mailing')
