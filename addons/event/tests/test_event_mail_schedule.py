...
from sleektiv.tests import tagged, users, warmup
...
class TestMailSchedule(EventCase, MockEmail, CronMixinCase):
    ...
    @mute_logger('sleektiv.addons.event.models.event_mail')
    @users('user_eventmanager')
    ...
    @mute_logger(
        'sleektiv.addons.event.models.event_mail',
        'sleektiv.addons.event.models.event_mail_registration',
        'sleektiv.addons.event.models.event_registration',
    )
