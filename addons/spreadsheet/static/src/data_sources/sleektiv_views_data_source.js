...
/**
 * @typedef {Object} SleektivModelMetaData
 * @property {string} resModel
 * @property {SleektivFields} [fields]
 *
 * @typedef {Object} SleektivModelSearchParams
 * @property {Object} context
 * @property {Array<string>} domain
 */

export class SleektivViewsDataSource extends LoadableDataSource {
    /**
     * @override
     * @param {Object} services
     * @param {Object} params
     * @param {SleektivModelMetaData} params.metaData
     * @param {Object} params.searchParams
     */
    constructor(services, params) {
        super(services);
        /** @type {SleektivModelMetaData} */
    ...
    /**
     * @returns {SleektivFields} List of fields
     */
    getFields() {
     ...
     * @returns {SleektivField | undefined} Field
     */
    getField(field) {
        this._assertMetaDataLoaded();
