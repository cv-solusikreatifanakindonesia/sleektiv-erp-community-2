...
export class SleektivLineChart extends SleektivChart {
...
chartRegistry.add("sleektiv_line", {
    match: (type) => type === "sleektiv_line",
    createChart: (definition, sheetId, getters) => new SleektivLineChart(definition, sheetId, getters),
    getChartRuntime: createSleektivChartRuntime,
    validateChartDefinition: (validator, definition) =>
        SleektivLineChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => SleektivLineChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => SleektivLineChart.getDefinitionFromContextCreation(),
    name: _t("Line"),
});
...
function createSleektivChartRuntime(chart, getters) {
    ...
    for (const index in datasets) {
        ...
        if (chart.fillArea) {
            ...
            // use the transparency of Sleektiv to keep consistency
