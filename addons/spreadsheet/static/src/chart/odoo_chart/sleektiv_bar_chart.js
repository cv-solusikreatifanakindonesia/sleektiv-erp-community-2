...
export class SleektivBarChart extends SleektivChart {
...
chartRegistry.add("sleektiv_bar", {
    match: (type) => type === "sleektiv_bar",
    createChart: (definition, sheetId, getters) => new SleektivBarChart(definition, sheetId, getters),
    getChartRuntime: createSleektivChartRuntime,
    validateChartDefinition: (validator, definition) =>
        SleektivBarChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => SleektivBarChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => SleektivBarChart.getDefinitionFromContextCreation(),
    name: _t("Bar"),
});
