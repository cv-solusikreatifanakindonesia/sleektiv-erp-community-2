...
import { Component, useRef, useSubEnv } from "@sleektiv/owl";
 ...
 * It uses a feature to automatically create links to other sleektiv pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
