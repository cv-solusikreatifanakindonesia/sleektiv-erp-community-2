...
from sleektiv.http import content_disposition, dispatch_rpc, request, Response
from sleektiv.service import db
from sleektiv.tools.misc import file_open, str2bool
from sleektiv.tools.translate import _

from sleektiv.addons.base.models.ir_qweb import render as qweb_render
...
class Database(http.Controller):
    ...
    def create(self, master_pwd, name, lang, password, **post):
        ...
        try:
            ...
            return request.redirect('/sleektiv')
