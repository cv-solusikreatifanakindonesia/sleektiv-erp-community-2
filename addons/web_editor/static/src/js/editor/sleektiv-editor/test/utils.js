...
import { SleektivEditor } from '../src/SleektivEditor.js';
...
export async function testEditor(Editor = SleektivEditor, spec, options = {}) {
    hasMobileTest = false;
...
export const pasteSleektivEditorHtml = async (editor, html) => pasteData(editor, html, 'text/sleektiv-editor');
...
export class BasicEditor extends SleektivEditor {}
