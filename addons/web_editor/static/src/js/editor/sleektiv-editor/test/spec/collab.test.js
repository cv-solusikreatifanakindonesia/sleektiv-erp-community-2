...
import { SleektivEditor, parseHTML, setSelection, insertCharsAt } from '../../src/SleektivEditor.js';
import {
...
const testMultiEditor = async spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        SleektivEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new SleektivEditor(clientInfo.editable, Object.assign({
            toSanitize: false,
    ...
    SleektivEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
