...
export class SleektivEditor extends EventTarget {
    constructor(editable, options = {}) {
        ...
        this.options = defaultOptions(
            {
                ...
                // `convertNumericToUnit` as sleektiv-editor utils to avoid this
        ...
        this.editable.classList.add("sleektiv-editor-editable");
     ...
     * from outside the sleektivEditor.
     */
    ...
    _onClipboardCopy(clipboardEvent) {
        ...
        const sleektivHtml = dataHtmlElement.innerHTML.replace(/\uFEFF/g, "");
        const sleektivText = selection.toString().replace(/\uFEFF/g, "");
        clipboardEvent.clipboardData.setData('text/plain', sleektivText);
        clipboardEvent.clipboardData.setData('text/html', sleektivHtml);
        clipboardEvent.clipboardData.setData('text/sleektiv-editor', sleektivHtml);
    }
    /**
     * @private
     */
    ...
    isSelectionInBlockRoot() {
        ...
        while (
            ...
            !currentNode.classList.contains('sleektiv-editor-editable') &&
    ...
    _onPaste(ev) {
        ...
        const sleektivEditorHtml = ev.clipboardData.getData('text/sleektiv-editor');
