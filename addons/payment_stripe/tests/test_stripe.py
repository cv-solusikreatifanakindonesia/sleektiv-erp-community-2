...
from sleektiv.addons.payment_stripe.tests.common import StripeCommon
...
class StripeTest(StripeCommon, PaymentHttpCommon):
    ...
    @mute_logger('sleektiv.addons.payment_stripe.models.payment_transaction')
    def test_tx_state_after_send_capture_request(self):
        self.provider.capture_manually = True
        tx = self._create_transaction('direct', state='authorized')

        with patch(
            'sleektiv.addons.payment_stripe.models.payment_provider.PaymentProvider'
    ...
    @mute_logger('sleektiv.addons.payment_stripe.controllers.main')
    def test_webhook_notification_confirms_transaction(self):
        """ Test the processing of a webhook notification. """
        tx = self._create_transaction('redirect')
        url = self._build_url(StripeController._webhook_url)
        with patch(
            'sleektiv.addons.payment_stripe.controllers.main.StripeController'
    ...
    def test_webhook_notification_tokenizes_payment_method(self):
        ...
        with patch(
            ...
            'sleektiv.addons.payment_stripe.models.payment_transaction.PaymentTransaction'
