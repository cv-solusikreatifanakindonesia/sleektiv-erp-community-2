...
from sleektiv.tools import py_to_js_locale
...
class AdyenController(http.Controller):
    ...
    def adyen_payment_methods(self, provider_id, formatted_amount=None, partner_id=None):
        ...
        shopper_reference = partner_sudo and f'SLEEKTIV_PARTNER_{partner_sudo.id}'
        data = {
    ...
    def adyen_return_from_3ds_auth(self, **data):
        ...
        # of Sleektiv in some cases. For instance, when a 3DS1 authentication is required, or for
