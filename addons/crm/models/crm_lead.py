...
from sleektiv.addons.mail.tools import mail_validation
...
from sleektiv.tools import date_utils, email_split, is_html_empty, groupby, parse_contact_from_email, SQL
