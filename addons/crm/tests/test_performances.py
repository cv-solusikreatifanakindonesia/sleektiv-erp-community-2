...
from sleektiv.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('sleektiv.models.unlink', 'sleektiv.addons.crm.models.crm_team', 'sleektiv.addons.crm.models.crm_team_member')
