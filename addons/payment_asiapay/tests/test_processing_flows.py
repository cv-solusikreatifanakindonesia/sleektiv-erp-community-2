...
from sleektiv.addons.payment_asiapay.controllers.main import AsiaPayController
...
class TestProcessingFlows(AsiaPayCommon, PaymentHttpCommon):
    ...
    @mute_logger('sleektiv.addons.payment_asiapay.controllers.main')
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'sleektiv.addons.payment_asiapay.controllers.main.AsiaPayController.'
