...
from sleektiv import api, Command, fields, models, tools, SUPERUSER_ID, _
from sleektiv.addons.rating.models import rating_data
from sleektiv.addons.web_editor.tools import handle_history_divergence
from sleektiv.exceptions import UserError, ValidationError, AccessError
from sleektiv.osv import expression
from sleektiv.tools import format_list, SQL
from sleektiv.addons.resource.models.utils import filter_domain_leaf
from sleektiv.addons.project.controllers.project_sharing_chatter import ProjectSharingChatter
...
class Task(models.Model):
    ...
    def action_redirect_to_project_task_form(self):
        ...
        return {
            'type': 'ir.actions.act_url',
            'url': f"/sleektiv/1/action-project.act_project_project_2_project_task_all/{self.id}?menu_id={menu_id}",
            'target': 'new',
        }
