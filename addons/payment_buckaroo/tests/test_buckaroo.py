...
from sleektiv.addons.payment_buckaroo.tests.common import BuckarooCommon
...
class BuckarooTest(BuckarooCommon, PaymentHttpCommon):
    ...
    def test_redirect_form_values(self):
        ...
        self.patch(type(self.env['base']), 'get_base_url', lambda _: 'http://127.0.0.1:7073')
    ...
    @mute_logger('sleektiv.addons.payment_buckaroo.models.payment_transaction')
    ...
    @mute_logger('sleektiv.addons.payment_buckaroo.controllers.main')
    def test_webhook_notification_confirms_transaction(self):
        """ Test the processing of a webhook notification. """
        tx = self._create_transaction('redirect')
        url = self._build_url(BuckarooController._webhook_url)
        with patch(
            'sleektiv.addons.payment_buckaroo.controllers.main.BuckarooController'
