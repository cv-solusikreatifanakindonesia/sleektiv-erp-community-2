...
from sleektiv.addons.mail_group.tests.data import GROUP_TEMPLATE
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('sleektiv.models.unlink', 'sleektiv.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('sleektiv.addons.base.models.ir_rule', 'sleektiv.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('sleektiv.addons.mail.models.mail_thread', 'sleektiv.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('sleektiv.addons.mail.models.mail_thread', 'sleektiv.addons.mail_group.models.mail_group_message', 'sleektiv.models.unlink')
    @users('employee')
    ...
    @mute_logger('sleektiv.addons.mail_group.models.mail_group')
    @users('employee')
